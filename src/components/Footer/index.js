...
const Footer = props => {
    return (
        <div className="footer">
            <footer role="contentinfo" className="footer_">
                <div className="footer-wrap">
                    <div className="footer-in">
                        ...
                        <section className="sections">
                            <h4 className="section-title">Host</h4>
                            <ul className="section-ul">
                                <li className="section-li">
                        ...
                        <section className="sections">
                            ...
                            <ul className="section-ul">
                                <li className="section-li">
                                    <a className="socials-button" href="https://www.facebook.com/TripperTravel.Inc/">
                                ...
                                <li className="section-li">
                                    <a className="socials-button" href="https://twitter.com/TripperInc">
                                ...
                                <li className="section-li">
                                    <a className="socials-button" href="https://www.instagram.com/trippertravel.inc/">
                                        <svg viewBox="0 0 32 32" role="img" aria-hidden="false" aria-label="Navigate to Instagram" focusable="false">
                                ...
                                <li className="section-li">
                                    <h2 className="telephone">Telephone: <br/>+2 12457924</h2>
                                </li>
                            </ul>
                        </section>
                    </div>
